...
import com.google.firebase.crashlytics.buildtools.reloc.org.checkerframework.checker.nullness.compatqual.NullableType;
...
/* package */ final class CustomProgressiveMediaPeriod
        implements MediaPeriod,
        ExtractorOutput,
        Loader.Callback<CustomProgressiveMediaPeriod.ExtractingLoadable>,
    ...
    public CustomProgressiveMediaPeriod(
            Uri uri,
        ...
        onContinueLoadingRequestedRunnable =
                () -> {
                    if (!released) {
                        checkNotNull(callback).onContinueLoadingRequested(CustomProgressiveMediaPeriod.this);
                    }
                };
    ...
    private final class SampleStreamImpl implements SampleStream {
        ...
        public boolean isReady() {
            return CustomProgressiveMediaPeriod.this.isReady(track);
        }

        @Override
        public void maybeThrowError() throws IOException {
            CustomProgressiveMediaPeriod.this.maybeThrowError(track);
        }

        @Override
        public int readData(
                FormatHolder formatHolder, DecoderInputBuffer buffer, @ReadFlags int readFlags) {
            return CustomProgressiveMediaPeriod.this.readData(track, formatHolder, buffer, readFlags);
        }

        @Override
        public int skipData(long positionUs) {
            return CustomProgressiveMediaPeriod.this.skipData(track, positionUs);
        }
    }

...
public final class CustomProgressiveMediaSource extends BaseMediaSource
    ...
    public static final class Factory implements MediaSourceFactory {
        ...
        /**
         * Creates a new factory for {@link CustomProgressiveMediaSource}s.
         *
        ...
        /**
         * Returns a new {@link CustomProgressiveMediaSource} using the current parameters.
         *
         * @param mediaItem The {@link MediaItem}.
         * @return The new {@link CustomProgressiveMediaSource}.
         * @throws NullPointerException if {@link MediaItem#localConfiguration} is {@code null}.
         */
        @Override
        public CustomProgressiveMediaSource createMediaSource(MediaItem mediaItem) {
            ...
            return new CustomProgressiveMediaSource(
                    mediaItem,
                    dataSourceFactory,
                    progressiveMediaExtractorFactory,
    ...
    private CustomProgressiveMediaSource(
            MediaItem mediaItem,
            DataSource.Factory dataSourceFactory,
            ProgressiveMediaExtractor.Factory progressiveMediaExtractorFactory,
    ...
    public MediaPeriod createPeriod(MediaPeriodId id, Allocator allocator, long startPositionUs) {
        ...
        System.out.println("createPeriod : " + localConfiguration.uri);
